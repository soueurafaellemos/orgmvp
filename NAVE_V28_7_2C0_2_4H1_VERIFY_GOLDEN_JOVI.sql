...
-- Golden JOVI — Resolution Action Contract Hotfix + Requirement Role & Binding Precision Verification
...
checks as (
  select jsonb_build_object(
    ...
    'c024h1_run_completed', exists(select 1 from req_run where status='completed' and pipeline_version='V28.7.2C0.2.4H1'),
