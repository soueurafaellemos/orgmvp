...
SUPPLIER_SECTIONS = [
    ("Identificação e contato", [("name", "Nome"), ("is_active", "Disponível para uso"), ("inactive_reason", "Motivo da inativação"), ("legal_name", "Razão social"), ("cnpj_normalized", "CNPJ"), ("company_type", "Tipo de empresa"), ("founded_year", "Ano de fundação"), ("website_url", "Site"), ("contact_name", "Contato"), ("contact_role", "Função do contato"), ("email", "E-mail"), ("phone", "Telefone"), ("whatsapp", "WhatsApp"), ("instagram_url", "Instagram"), ("linkedin_url", "LinkedIn"), ("address", "Endereço"), ("notes", "Observações")]),
...
BOOLEAN_FIELDS = {"customizable", "staff_included", "serves_nationally", "has_local_teams", "equipment_transport_required", "accommodation_required", "own_installation_team", "quality_control", "accepts_technical_visit", "emits_invoice", "has_warranty", "large_volume_flexibility", "works_with_contract", "is_active"}
