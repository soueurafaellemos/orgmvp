...
--
-- H3.1 corrige dois falsos verdes possíveis do H3:
  ...
  select jsonb_build_object(
    ...
    'c024h31_run_completed', exists(
      ...
      where status='completed'
        and pipeline_version='V28.7.2C0.2.4H3.1'
    ),
    ...
    -- Critical H3.1 precision checks. Terminal punctuation is normalized first.
