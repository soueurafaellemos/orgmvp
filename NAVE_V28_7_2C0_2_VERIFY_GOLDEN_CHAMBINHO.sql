-- NAVE by VOE · V28.7.2C0.2 — Golden Chambinho verification
...
with target_project as (
  ...
  select jsonb_build_object(
    ...
    'active_c0_occurrences_are_c02',not exists(
      select 1 from occ where coalesce(attributes->>'normalized_by','') <> 'V28.7.2C0.2'
    ),
